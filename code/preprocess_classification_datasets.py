...
def load_preprocessed_classification_data(dataset_name, show_preview = False):
    # pd.read_csv("{}{}_clf_data.pickle".format(DATA_FOLDER, dataset_name), encoding='unicode_escape')
    data = pickle.load(open("{}{}_clf_data.pickle".format(DATA_FOLDER, dataset_name), mode="rb"))
